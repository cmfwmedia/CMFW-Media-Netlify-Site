...
const apiUrl = 'https://api.dronelogbook.com/equipment';
...
export const handler = async (event, context) => {
    try {
        const equipmentData = await fetchData(apiUrl);
        ...
        return {
            statusCode: 200,
            body: JSON.stringify({ message: 'equipment data pushed to Supabase' }),
        };
    } catch (error) {
